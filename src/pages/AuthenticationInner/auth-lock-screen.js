...
const LockScreen = () => {
  document.title = "Lockscreen | Equity Circle - Responsive Bootstrap 5 Admin Dashboard";
                        ...
                        <Row className="justify-content-center">
                            <Col md="8" lg="6" xl="5">
                                ...
                                <div className="mt-5 text-center">
                                    ...
                                    <p>© 2021 Equity Circle. Crafted with <i className="mdi mdi-heart text-danger"></i> by Themesbrand</p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
