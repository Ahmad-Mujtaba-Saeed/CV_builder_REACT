                ...
                <Row className="justify-content-center">
                    <Col md={8} lg={6} xl={5}>
                        <Card className="overflow-hidden">
                            <CardBody className="pt-0">
                                ...
                                <div className="p-3">
                                    ...
                                    <p className="text-muted text-center">Get your free Equity Circle account now.</p>
                                    <Form
                                      ...
                                      {registrationError && registrationError ? (
                                        ...
                                        <div className="mb-0 row">
                                            <div className="col-12 mt-4">
                                                <p className="text-muted mb-0 font-size-14">By registering you agree to the Equity Circle <Link to="#" className="text-primary">Terms of Use</Link></p>
                                            </div>
                                        </div>
                                    </Form>
                                </div>
                        ...
                        <div className="mt-5 text-center">
                            ...
                            © <script>document.write(new Date().getFullYear())</script> Equity Circle <span className="d-none d-sm-inline-block"> - Crafted with <i className="mdi mdi-heart text-danger"></i> by Themesbrand.</span>
                        </div>
                    </Col>
                </Row>
            </Container>
