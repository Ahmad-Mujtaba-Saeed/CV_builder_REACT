...
const CVBuilder = () => {
    ...
    useEffect(() => {
        if (parsedResume?.education && educationEditModes.length === 0) {
            ...
            setEducationEditModes(new Array(parsedResume.education.length).fill(false));
        }
    ...
    useEffect(() => {
        if (parsedResume?.workExperience && employmentEditModes.length === 0) {
            setEmploymentEditModes(new Array(parsedResume.workExperience.length).fill(false));
        }
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <div className="d-flex flex-wrap gap-2">
                                                {parsedResume?.skill
                                                    ...
                                                    .map((skill, index) => (
                                                        <span key={index} className="badge bg-primary me-2 mb-2 d-inline-flex align-items-center skill-badge">
                                                            {skill.name}
                                                            <button
                                                                type="button"
                                                                className="ms-1"
        ...
        if (activeTab === 'Design') {
            return (
                <Card>
                    <Card.Body>
                        <h5>Design</h5>
                        <p>This is the Design card content.</p>
                    </Card.Body>
                </Card>
            );
        }
